...
export function Gallery() {
	...
	return (
		<div className="container py-12">
			<div>
				<h1 className="text-4xl font-bold">Explore Our Tours</h1>
				<p className="mt-4 text-lg text-muted-foreground">
					Discover breathtaking destinations and exciting travel experiences with our
					exclusive tours and packages.
				</p>
