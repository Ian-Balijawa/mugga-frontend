...
export function Videos() {
	...
	return (
		<div className="container py-12">
			...
			>
				<h1 className="text-4xl font-bold">Explore Our Travel Videos</h1>
				<p className="mt-4 text-lg text-muted-foreground">
					Watch our collection of videos showcasing beautiful destinations, customer
					experiences, and travel highlights.
				</p>
				...
				{items.length === 0 && (
					<p className="mt-12 text-center text-muted-foreground">
						No travel videos available at the moment.
					</p>
				)}
			</motion.div>
		</div>
