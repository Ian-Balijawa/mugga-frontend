...
export function Facilities() {
	...
	return (
		<div className="container py-12">
			...
			>
				<h1 className="text-4xl font-bold">Our Travel Facilities</h1>
				<p className="mt-4 text-lg text-muted-foreground">
					Explore our range of world-class facilities designed for a seamless and
				...
				{/* Equipment Section */}
				<div className="mt-24">
					<h2 className="text-3xl font-bold">Travel Equipment & Technology</h2>
					<p className="mt-4 text-lg text-muted-foreground">
						We provide the latest equipment and technology to enhance your travel
						experience.
					</p>
...
const equipmentCategories = [
	{
		...
		items: ["Luxury resorts", "Budget hotels", "Guest houses", "Vacation rentals"],
	},
	{
		name: "Transportation",
		items: ["Private cars", "Bus tours", "Airline partnerships", "Shuttle services"],
	},
	{
