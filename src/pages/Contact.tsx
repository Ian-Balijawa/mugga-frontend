...
import { MapPin, Phone, Mail, Globe, Users, Clock, Building2 } from "lucide-react";
									...
									<div className="flex items-start gap-4">
										...
										<div>
											...
											<p className="mt-1 text-sm text-muted-foreground">
												Tours & Travel Office, Kampala Road, Plot 123
												<br />
												Near Safari Mall, Shop No: 001
											</p>
											<div className="mt-4">
